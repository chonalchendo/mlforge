...
v0.2.0 focuses on improving SDK usability and enabling team workflows. No new compute backends or online stores—just making the existing system more practical for real projects.
...
```json
{
  ...
  "features": {
    "merchant_spend": {
      ...
      "interval": "1d",
      "columns": [
        {"name": "amt__count__7d", "input": "amt", "agg": "count", "window": "7d"},
        {"name": "amt__count__30d", "input": "amt", "agg": "count", "window": "30d"},
        ...
      ],
      "tags": ["merchants"],
