...
|---------|--------|--------|----------|------|
| [PySpark Engine](v0.8.0/pyspark-engine.md) | Planned | High | No | [Link](v0.8.0/pyspark-engine.md) |
| [Unity Catalog Store](v0.8.0/unity-catalog-store.md) | Planned | Medium | No | [Link](v0.8.0/unity-catalog-store.md) |
| [Databricks Online Tables](v0.8.0/databricks-online-tables.md) | Planned | Medium | No | [Link](v0.8.0/databricks-online-tables.md) |
| [Incremental Builds](v0.8.0/incremental-builds.md) | Planned | Medium | No | [Link](v0.8.0/incremental-builds.md) |
| [Tag-Based Scheduling](v0.8.0/tag-scheduling.md) | Planned | Low | No | [Link](v0.8.0/tag-scheduling.md) |
...
|-------|-------------|--------|
| 1 | PySpark Engine | Planned |
| 2 | PySpark Compiler (rolling metrics) | Planned |
| 3 | Unity Catalog Store | Planned |
| 4 | Version mapping (semver ↔ Delta) | Planned |
| 5 | Databricks Online Tables | Planned |
| 6 | Incremental Builds | Planned |
| 7 | Tag-Based Scheduling | Planned |
| 8 | Metric Definitions API (Field, Aggregate) | Planned |
| 9 | Profile integration | Planned |
| 10 | Engine parity tests | Planned |
...
### Features
- [ ] PySpark Engine complete
- [ ] PySpark Compiler (rolling metrics) complete
- [ ] Unity Catalog Store complete
- [ ] Databricks Online Tables complete
- [ ] Incremental Builds complete (`--since`, `--until`, `--last`, `--full-refresh`)
- [ ] Tag-Based Scheduling complete (`--schedule` flag)
...
- [ ] Coverage >= 80%
- [ ] No ruff/ty errors
- [ ] Engine parity tests passing (Polars vs DuckDB vs PySpark)
