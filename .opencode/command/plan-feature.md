---
description: Create a comprehensive feature specification for collaborative planning
---
...
Use @codebase-explorer to understand the current state and patterns:
...
Use @researcher to investigate how similar tools handle this feature:
